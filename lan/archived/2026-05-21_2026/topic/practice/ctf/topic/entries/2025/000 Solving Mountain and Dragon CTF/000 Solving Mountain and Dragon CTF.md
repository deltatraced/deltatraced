...
It can be found [here](https://2tie.rustedlogic.net/games/adv/adventure.html) [^1](000%20Solving%20Mountain%20and%20Dragon%20CTF.md#1).
...
The files for this game, including ones to be modified, are to be references in  [lan-exp-scripts files](https://github.com/LanHikari22/lan-exp-scripts/tree/main/files/2025/persistent/000-mountain-n-dragon-ctf) [^2](000%20Solving%20Mountain%20and%20Dragon%20CTF.md#2).
